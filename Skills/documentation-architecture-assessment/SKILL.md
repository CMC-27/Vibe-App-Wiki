...
This skill defines the active **Auditing and Maintenance Workflow** for managing a project's `/docs` library. It ensures the library stays perfectly aligned with the code as features evolve.
